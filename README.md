...
Claude Code är Anthropics AI-agent för mjukvaruutveckling. Den körs i 
terminalen (eller som tillägg i din editor) och hjälper dig att skriva, 
felsöka och förstå kod genom naturligt språk. Det här projektet förklarar 
konceptet steg för steg, på svenska.

## Vem är detta för?

- Dig som pratar svenska och vill lära dig Claude Code utan språkhinder
