...
![Claude Desktop Inställningar > Funktioner, med pil som pekar mot "Starta import"-knappen för att importera minne](bilder/importera-minne-claude-desktop-installningar-funktioner.png)

**3)** Kopiera prompten och klistra in den i den LLM du har en historik med

![Dialogrutan "Import memory to Claude" med pil som pekar mot Kopiera-knappen för importprompten](bilder/kopiera-prompt-chatgpt-gemini-till-claude-minne.png)

**4)** Klistra in svaret i resultatrutan enligt instruktionerna

![Dialogrutan "Import memory to Claude" med pil som pekar mot resultatrutan där svaret ska klistras in](bilder/klistra-in-svar-resultatruta-claude-lagg-till-minne.png)
